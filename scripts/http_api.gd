...
func is_local_qa_profile_requested() -> bool:
	...
	for argument in OS.get_cmdline_args():
		...
		if (
			...
			or normalized.ends_with("/final_story_continuation_qa_test.tscn")
			...
			or normalized.ends_with("/game_hud_runtime_test.tscn")
			or normalized.ends_with("/game_hud_playtime_label_test.tscn")
			or normalized.ends_with("/zip_map_restoration_test.tscn")
