...
func _run() -> void:
	...
	_assert_equal(oak_source.contains("[node name=\"TaskDialogAdapter\""), true, "Oak Leaf preserves the Bandit dialogue adapter")
	_assert_equal(oak_source.contains("require_task_index = 2"), true, "Bandit dialogue remains scoped to task 2")
