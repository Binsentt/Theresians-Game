...
func _run() -> void:
	...
	_expect(_function_block(source, "func _submit_canonical_task_activity").contains("telemetry_contract_version"), "Canonical activity requests carry the versioned telemetry contract.")
	_expect(_function_block(source, "func _submit_canonical_task_activity").contains("activity_event_id"), "Canonical activity requests carry a stable event identity.")
	_expect(_function_block(source, "func _submit_canonical_task_activity").contains("duration_seconds"), "Canonical activity requests carry measured task duration.")
